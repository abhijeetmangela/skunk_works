...
t_cr_2 = cruise_dist_2 / V_cruise_2
t_loiter = 15 * 60
...
def Total_energy(Weight):
    ...
    energy_cruise_2 = Power_cruise(V_cruise_2, Weight-payload_mass_drop*g) * t_cr_2
...
print(f"Battery Energy    : {Total_energy(final_weight*g):.3f} Joules")
print(f"Battery           : {Total_energy(final_weight*g)/(11.2*3.6):.3f} Mah")
